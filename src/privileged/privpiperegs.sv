...
module privpiperegs (
  ...
  input  logic         IllegalIEUFPUVPUInstrD,              // illegal IEU, FPU, or VPU instruction decoded
  output logic         InstrPageFaultM, InstrAccessFaultM,  // delayed instruction faults
  output logic         IllegalIEUFPUVPUInstrM,              // delayed illegal IEU, FPU, or VPU instruction
